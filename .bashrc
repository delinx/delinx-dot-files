...
alias csize="bash ~/scripts/csize.sh"

. "$HOME/.cargo/env"

alias zzip='tar --use-compress-program="pigz -k " -cf'

alias qlog='cat ~/.local/share/qtile/qtile.log'
alias qlogclr='rm ~/.local/share/qtile/qtile.log;touch ~/.local/share/qtile/qtile.log'
alias vim="nvim"
alias vi="nvim"
